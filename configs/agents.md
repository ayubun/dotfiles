...
When authoring commit messages for me, de-slopify outputs. Do not add long descriptions. Make them very short and all lowercase. Do not add "fix"/"chore"/etc prefixes, as I don't do that. It makes it look VERY AI generated. Try to keep things to as FEW commits as possible, and use git commit amend when it feels reasonable, renaming the combined commit to fit the needs. Do not include characters which are AI-like, such as em-dashes and non-alphanumeric unicodes
